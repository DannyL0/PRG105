...
class AddGUI:
    def __init__(self, master):
        ...
        self.add.title('Adding Customer')
        ...
        # widgets for top frame - label and entry box for name
        self.name_label = tkinter.Label(self.top_frame, text='Enter the name: ')
        # Entry box uses its own font settings, so tell it to use the TkDefaultFont we set for the primary window
        self.name_entry = tkinter.Entry(self.top_frame, width=15, font="TkDefaultFont")
        self.email_label = tkinter.Label(self.middle_frame, text='Enter the email: ')
        ...
        # buttons for bottom frame
        self.add_button = tkinter.Button(self.bottom_frame, text='Add Customer', command=self.add_customer, width=15)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.go_back, width=10)
...
class ChangeGUI:
    def __init__(self, master):
        ...
        self.change.title('Updating Customer Info')
        ...
        # widgets for top frame - label and entry box for name
        self.name_label = tkinter.Label(self.top_frame, text='Enter the name you want to update: ')
        # Entry box uses its own font settings, so tell it to use the TkDefaultFont we set for the primary window
        self.name_entry = tkinter.Entry(self.top_frame, width=15, font="TkDefaultFont")
        ...
        # buttons for bottom frame
        self.change_button = tkinter.Button(self.bottom_frame, text='Update Customer', command=self.change_customer,
                                            width=15)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.go_back, width=10)
...
class DeleteGUI:
    def __init__(self, master):
        ...
        self.delete.title('Deleting Customer Info')
        ...
        # widgets for top frame - label and entry box for name
        self.name_label = tkinter.Label(self.top_frame, text='Enter the name you want to delete: ')
        # Entry box uses its own font settings, so tell it to use the TkDefaultFont we set for the primary window
        self.name_entry = tkinter.Entry(self.top_frame, width=15, font="TkDefaultFont")
        ...
        # buttons for bottom frame
        self.delete_button = tkinter.Button(self.bottom_frame, text='Delete Customer', command=self.delete_customer,
                                            width=15)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.go_back, width=10)
